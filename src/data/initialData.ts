...
export const initialAuditLogs: AuditLog[] = [
  {
    ...
    details: 'Approved member application for Engr. Amina Shehu Sokoto (NNEPEF/SK/0006)',
...
export const initialNotificationLogs: NotificationDeliveryLog[] = [
  ...
  },
  {
    ...
    message: 'Welcome to N-NEPEF 2020! Your membership ID is NNEPEF/KN/0001. Status: ACTIVE.',
    status: 'Sent',
